  ...
  return (
    <section id="about" className="py-24 md:py-28 bg-neutral-light">
      <div className="container max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-7 mb-7">
          <div className="flex-1 bg-white shadow-xl border border-border/60 rounded-2xl p-7 min-w-0">
